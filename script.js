...
(function () {
  ...
  var RESTAURANTES = [
    { id: 'r1', nombre: 'Pizzería Napoli', categoria: 'pizza', img: './assets/rest-r1.svg', rating: 4.8, badge: 'Top' },
    { id: 'r2', nombre: 'Sushi Roll', categoria: 'asiatica', img: './assets/rest-r2.svg', rating: 4.6, badge: null },
    { id: 'r3', nombre: 'Burger Norte', categoria: 'hamburguesas', img: './assets/rest-r3.svg', rating: 4.5, badge: 'Popular' },
    { id: 'r4', nombre: 'Mamma Mia Express', categoria: 'pizza', img: './assets/rest-r4.svg', rating: 4.7, badge: null }
  ];

  /** Platos por restaurante (cada uno con imagen en ./assets/) */
  var MENU = {
    r1: [
      { id: 'm1', nombre: 'Margarita', precio: 8.5, img: './assets/dish-m1.svg', desc: 'Tomate, mozzarella, albahaca' },
      { id: 'm2', nombre: 'Cuatro quesos', precio: 10.9, img: './assets/dish-m2.svg', desc: 'Mozzarella, gorgonzola, parmesano, ricota' }
    ],
    r2: [
      { id: 'm3', nombre: 'Menú maki (12 pzs)', precio: 14.0, img: './assets/dish-m3.svg', desc: 'Salmón, atún, pepino, aguacate' },
      { id: 'm4', nombre: 'Yakisoba', precio: 9.5, img: './assets/dish-m4.svg', desc: 'Fideos orientales con verduras' }
    ],
    r3: [
      { id: 'm5', nombre: 'Clásica + patatas', precio: 11.0, img: './assets/dish-m5.svg', desc: 'Carne de res, queso, bacon, lechuga' },
      { id: 'm6', nombre: 'Veggie', precio: 10.5, img: './assets/dish-m6.svg', desc: 'Verduras grilladas, queso de cabra' }
    ],
    r4: [
      { id: 'm7', nombre: 'Calzone', precio: 9.0, img: './assets/dish-m7.svg', desc: 'Jamón, queso, tomate horneado' },
      { id: 'm8', nombre: 'Prosciutto', precio: 11.5, img: './assets/dish-m8.svg', desc: 'Jamón italiano, rúcula, parmesan' }
    ]
  };
  ...
  function filtrarRestaurantes() {
    ...
    for (var i = 0; i < RESTAURANTES.length; i++) {
      ...
      var badgeHtml = r.badge ? '<span class="card-badge">' + r.badge + '</span>' : '';
      var ratingHtml = '<span class="card-rating"><svg viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>' + r.rating + '</span>';
      btn.innerHTML =
        '<span class="card-rest__media">' + badgeHtml + '<img src="' +
        r.img +
  ...
  function abrirMenu(restId) {
    ...
    for (var j = 0; j < platos.length; j++) {
      ...
      li.innerHTML =
        ...
        '</span><span class="plato-desc">' +
        escapeHtml(pl.desc || '') +
        '</span></div>' +
        '<div class="plato-actions"><span class="plato-precio">' +
